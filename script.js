...
const client_id = "AeeiZTEBZJd3UYBFOoDMxxzMugaYIE1xoGUoexwXQmYBUIrorDDv1Oeibrw_39aMRJHHTg8HTmg8HjN2";
const currency = "USD";
...
.then(() => {
    ...
    let paypal_buttons = paypal.Buttons({ // https://developer.paypal.com/sdk/js/reference
        ...
        createOrder: function(data, actions) { //https://developer.paypal.com/docs/api/orders/v2/#orders_create
            return fetch("https://paypal-checkout-nken.onrender.com/create_order", {
        ...
        onApprove: function(data, actions) {
            ...
            return fetch("https://paypal-checkout-nken.onrender.com/complete_order", {
                method: "post", headers: { "Content-Type": "application/json; charset=utf-8" },
                body: JSON.stringify({
                    "intent": intent,
                    "order_id": order_id
